...
del .\output\*.* /Q
"c:/program files/java/jdk1.5.0_06/bin/javac.exe" -source 1.3 -target 1.1 -bootclasspath %CP% ./src/*.java ./src/ru/develgame/JNDSWindowsManager/*.java ./src/ru/develgame/JNDSWindowsManager/Components/*.java
